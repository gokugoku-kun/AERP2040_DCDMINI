...
audio_pwm_setup(const audio_format_t *intended_audio_format,
 ...
 */
extern bool audio_pwm_connect_thru(audio_buffer_pool_t *producer, audio_connection_t *connection);
